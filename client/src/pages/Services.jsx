      ...
      <section className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center">
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-medium text-white mb-4">Services</h2>
            <p className="text-gray-300 text-lg">Leave us a little info, and we'll be in touch.</p>
            <button className="mt-6 px-8 py-3 bg-purple-600 text-white font-semibold rounded hover:bg-purple-700 transition cursor-pointer">
              Contact Us
            </button>
          </div>
        </div>
      ...
      <section className="py-8 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mb-8 text-sm text-gray-600">
            <span>Home</span> <span className="mx-2">›</span> <span>Services</span>
          </div>
