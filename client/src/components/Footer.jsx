    ...
    <div className="w-full bg-[#0a0a0a] text-gray-300">
      ...
      <div className="w-full border-b border-gray-700">
        <div className="max-w-7xl mx-auto px-6 py-20 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          {/* LEFT TEXT */}
          <div>
            <p className="uppercase text-sm text-gray-400 tracking-wider mb-2">
              Let's Talk
            </p>
            ...
            <p className="text-gray-400 max-w-xl">
              We’re a team of creatives who build websites, apps, brands, UI/UX
              and digital identities that help businesses grow and stand out.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-14">
          ...
          <div>
            ...
            <p className="text-gray-400 leading-relaxed">
              We help clients build modern websites, apps, branding, UI/UX and
          ...
          <div>
            ...
            <p className="font-semibold text-gray-200 mt-1">
              devcops123@gmail.com
            </p>
            <p className="font-semibold text-gray-200">+91 7325842656</p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="border border-gray-500 p-2 rounded-full hover:border-blue-600 hover:text-blue-600 transition"
              >
                <FaFacebookF />
              </a>

              <a
                href="https://www.instagram.com/devxcops?igsh=MTFrazBob2U1aGVhMg=="
                target="_blank"
                rel="noopener noreferrer"
                className="border border-gray-500 p-2 rounded-full hover:border-blue-600 hover:text-blue-600 transition"
              >
              ...
              <a
                href="https://www.linkedin.com/in/devxcops-994a42380?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                target="_blank"
                rel="noopener noreferrer"
                className="border border-gray-500 p-2 rounded-full hover:border-blue-600 hover:text-blue-600 transition"
              >
      ...
      <div className="w-full py-6 text-center text-gray-500 text-sm">
        © {new Date().getFullYear()} devXcops Digital Services. All rights
        reserved.
      </div>
